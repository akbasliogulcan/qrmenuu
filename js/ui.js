...
//*Detay sayafasını renderlamak için de kullanabiliriz bu fonksiyonu
...
//! Aşağıda product detail.js den geliyor ve outlet de detail.htmlden geliyor.
const renderDetailPage = (product, outlet) => {

           //*Fonskiyona dışarıda verilen outlet değerinin içeriğini oluştur.
           outlet.innerHTML = `<div class="d-flex justify-content-between ">
                      ...
                      <h1 class="text-center">Ürün Detayları</h1>

                      <img src="${product.img}" style="max-height: 400px;" alt="product-image"
...
<div class="card">
  ...
  <div class="message-text-container text-center">
    <p class="message-text">Warning message</p>
    <p class="sub-text">ÜRÜN BULUNAMADI! </p>
  </div>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 15 15"
...
export { elements, renderCard, renderDetailPage, renderNotFound };